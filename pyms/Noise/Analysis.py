...
def window_analyzer(i: IonChromatogram, window: Union[int, str] = _DEFAULT_WINDOW, n_windows: int = _DEFAULT_N_WINDOWS, rand_seed: Optional[Union[int, str]] = None) -> float:
	"""
